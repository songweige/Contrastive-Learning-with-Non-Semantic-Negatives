...
Run ``python preprocess/imangenet_t

## Training

The following code is used to pre-train MoCo-v2 + patch/texture-based NS. The main part has minimal modifications compared with the [official implementation](https://github.com/facebookresearch/moco). 
...
The following code is used to reproduce MoCo-v2 + patch-based NS results in Table 1. 
